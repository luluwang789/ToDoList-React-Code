...
function App() {
  ...
  const onDeleteBtnClick = (id)=>{
    var data = JSON.parse(localStorage.getItem(TODO_APP_STORAGE_KEY));
  ...
  return (
    <>
      ...
      <div className="app">
        ...
        ></Textfield>
        <TodoList className="todolist" todoList={todoList} onCheckBtnClick={onCheckBtnClick} onDeleteBtnClick={onDeleteBtnClick}/>
      </div>
    </>
  );
}
